      ...
      <aside className={`po-sidebar ${isMobileMenuOpen ? 'open' : ''}`}>
        ...
        <div className="po-sidebar-bottom">
          ...
          >
            ...
            <span className="po-notif-badge">3</span>
          </button>
          ...
          <div className="po-grid">
            ...
            <section className="po-card po-card-prefs">
              ...
              <div className="po-prefs-list">
                ...
                <div className="po-pref-row">
                  <span className="po-pref-label">Pesan dari guru</span>
                  <button 
                    onClick={() => togglePref('pesanGuru')}
                    className={`po-toggle-badge ${prefs.pesanGuru ? 'active' : 'inactive'}`}
                  >
                    {prefs.pesanGuru ? 'Aktif' : 'Nonaktif'}
                  </button>
                </div>

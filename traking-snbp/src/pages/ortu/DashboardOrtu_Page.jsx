        ...
        <div className="db-ortu-container">
            ...
            <aside className={`db-ortu-sidebar ${isMobileMenuOpen ? 'open' : ''}`}>
                <div>
                    ...
                    <nav className="db-ortu-nav">
                        ...
                        <button
                            ...
                            className={`db-ortu-nav-item ${activeTab === 'pesan' ? 'active' : ''}`}
                        >
                            <span className="db-ortu-nav-icon">✉</span>
                ...
                <div className="db-ortu-sidebar-bottom">
                    ...
                    >
                        ...
                        {/* Red Badge #A32D2D */}
                        <span className="db-ortu-notif-badge">3</span>
                    </button>
            ...
            <div className="db-ortu-main">
                ...
                <main className="db-ortu-content">
                        ...
                        <div className="db-ortu-alert-left">
                            ...
                            <div className="db-ortu-alert-text">
                                ...
                                <p className="db-ortu-alert-desc">
                                    Prediksi lolos SNBP: 41% &bull; Nilai rata-rata: 58.1 &bull; Kehadiran: 72%
                                </p>
                            </div>
                        </div>
                        <button
                            onClick={() => navigate('/ortu/prediksi-snbp')}
                    ...
                    {/* 3 Metric Cards - Burgundy Red #A32D2D */}
                    <div className="db-ortu-stats-grid">
                        ...
                        {/* Card 3: Prediksi Lolos */}
                        <div className="db-ortu-stat-card">
                            <span className="db-ortu-stat-label">Prediksi lolos SNBP</span>
                            <div className="db-ortu-stat-value">41%</div>
                            <div className="db-ortu-stat-sub">
                                Status: Berisiko
                            </div>
                        </div>
                    ...
                    <div className="db-ortu-bottom-grid">
                        ...
                        {/* KOLOM KANAN: Card Pesan Guru + Card Sesi Konseling (Grid col-span 5) */}
                        <div className="db-ortu-right-stack">

                            {/* Card Pesan Wali Kelas */}
                            <section className="db-ortu-card">
                                <h3 className="db-ortu-card-title">Pesan dari wali kelas</h3>

                                {/* Quote block - Blue #185FA5 */}
                                <div className="db-ortu-quote-block">
                                    &ldquo;Farhan perlu perhatian lebih di rumah. Nilai dan kehadiran menurun. Mohon motivasi dan pastikan istirahat cukup.&rdquo;
                                </div>

                                <div className="db-ortu-quote-author">
                                    &mdash; Ibu Sari R. &bull; 15 Mei 2026
                                </div>

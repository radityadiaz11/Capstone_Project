...
function NotifikasiOrtu_Page() {
  ...
  const notifications = [
    ...
    },
    {
      id: 2,
      type: 'warning',
      message: 'Sesi konseling dijadwalkan: 5 Mei 2026 · Topik: Motivasi & kehadiran',
      time: 'Kemarin, 14.00',
      icon: '📅',
      bold: true,
    },
    ...
    },
    {
      id: 4,
      type: 'message',
      message: 'Ada pesan baru dari Ibu Sari Rahayu (Wali Kelas).',
      time: '5 hari lalu',
      icon: '📝',
      bold: false,
    },
      ...
      <aside className={`no-sidebar ${isMobileMenuOpen ? 'open' : ''}`}>
        ...
        <div className="no-sidebar-bottom">
          ...
          >
            ...
            <span className="no-notif-badge">3</span>
          </button>

...
function EksporData_Page() {
    ...
    const riwayatEkspor = [
        ...
        { label: 'Prediksi Model v2.1', type: 'CSV', typeClass: 'ekd-badge-csv' },
                ...
                <main className="ekd-content">
                    <div className="ekd-grid">
                        ...
                        <div className="ekd-left">
                            ...
                            {/* Card 3: Rekap Prediksi Model AI */}
                            <div className="ekd-card">
                                <div className="ekd-card-header">
                                    <div>
                                        <h3 className="ekd-card-title">Rekap prediksi model AI</h3>
                                        <p className="ekd-card-desc">
                                            Output prediksi lengkap dengan skor confidence seluruh kelas XII.
                                        </p>
                                    </div>
                                    <span className="ekd-badge ekd-badge-csv">CSV</span>
                                </div>
                                <button
                                    className={`ekd-btn ${loadingItem === 'csv' ? 'ekd-btn-loading' : ''}`}
                                    onClick={() => handleExport('csv')}
                                    disabled={loadingItem === 'csv'}
                                >
                                    {loadingItem === 'csv' ? (
                                        <span className="ekd-spinner"></span>
                                    ) : (
                                        <>Ekspor CSV <span className="ekd-btn-arrow">↗</span></>
                                    )}
                                </button>
                            </div>
                        ...
                        <div className="ekd-right">
                            <div className="ekd-card ekd-riwayat-card">
                                ...
                                <p className="ekd-riwayat-note">Semua file tersimpan 30 hari</p>
                            </div>
                        </div>

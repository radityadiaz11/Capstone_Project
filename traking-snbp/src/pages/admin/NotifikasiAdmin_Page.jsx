...
const notifikasiData = [
    ...
    },
    {
        id: 2,
        icon: '✓',
        iconClass: 'nka-icon-success',
        pesan: 'Model AI berhasil diperbarui. Akurasi naik dari 84% ke 87.3%.',
        waktu: 'Kemarin, 15.00',
        isUnread: true,
    },
    {
    ...
    },
    {
        id: 4,
        icon: '📋',
        iconClass: 'nka-icon-info',
        pesan: 'Ibu Sari Rahayu telah menjadwalkan 4 sesi bimbingan konseling bulan ini.',
        waktu: '3 hari lalu',
        isUnread: false,
    },
];

            ...
            <aside className={`dbs-sidebar ${isMobileMenuOpen ? 'open' : ''}`}>
                ...
                <div className="dbs-sidebar-bottom">
                    <button className="dbs-nav-item"
                        ...
                        <span className="dbs-notif-badge">2</span>
                    </button>
            ...
            <div className="dbs-main">
                ...
                <main className="dbs-content">
                    ...
                    <div className="dbs-stats-grid">
                        ...
                        <div className="dbs-stat-card">
                            <span className="dbs-stat-label">Prediksi lolos SNBP</span>
                            <div className="dbs-stat-value dbs-val-green">142</div>
                            <div className="dbs-stat-sub dbs-sub-green">↑ 18 dari tahun lalu</div>
                        </div>
                        ...
                        <div className="dbs-stat-card">
                            <span className="dbs-stat-label">Akurasi model AI</span>
                            <div className="dbs-stat-value dbs-val-blue">87%</div>
                            <div className="dbs-stat-sub">Gradient Boosting</div>
                        </div>
                                ...
                                <table className="dbs-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Wali Kelas</th>
                                            <th>Siap</th>
                                            <th className="dbs-th-perhatian">Perhatian</th>
                                    ...
                                    <tbody>
                                        {kelasData.map((row) => (
                                            <tr key={row.kelas}>
                                                ...
                                                <td>{row.wali}</td>
                                                <td>{row.siap}</td>
                                                <td className="dbs-td-perhatian">{row.perhatian}</td>
                            ...
                            <section className="dbs-card">
                                ...
                                <div className="dbs-summary-list">
                                    <div className="dbs-summary-row">
                                        <span className="dbs-summary-label">Prediksi lolos</span>
                                    ...
                                    <div className="dbs-summary-row">
                                        <span className="dbs-summary-label">Update model AI</span>
                                        <span className="dbs-summary-val">1 Mei 2026</span>
                                    </div>
                                    <div className="dbs-summary-row">
                                        <span className="dbs-summary-label">Akurasi model</span>
                                        <span className="dbs-summary-val dbs-val-green">87%</span>
                                    </div>
                                </div>
                            </section>
